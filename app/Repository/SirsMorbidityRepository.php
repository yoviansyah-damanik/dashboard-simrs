...
interface SirsMorbidityInterface
{
    public static function getRL41(int $tahun, int $bulan): array;
    public static function getRL42(int $tahun, int $bulan): array;
    public static function getRL43(int $tahun, int $bulan): array;
    public static function getRL51(int $tahun, int $bulan): array;
    public static function getRL52(int $tahun, int $bulan): array;
    public static function getRL53(int $tahun, int $bulan): array;
}

class SirsMorbidityRepository implements SirsMorbidityInterface
{
    const KONEKSI = 'simrs';

    /** RL 4.1 - Morbiditas Rawat Inap (matrix kelompok umur x ICD-10) */
    public static function getRL41(int $tahun, int $bulan): array
    {
        $labels = SirsHelper::getAgeGroupLabels();
        ...
        foreach ($rows as $row) {
            ...
            $kelUmur = SirsHelper::getAgeGroup($row->tgl_lahir, $row->tgl_keluar);
            $jk = $row->jk;
        ...
        $kematian = DB::connection(self::KONEKSI)->select("
    ...
    public static function getRL42(int $tahun, int $bulan): array
    {
        ...
        $kematian = self::getKematianByGroup($bulan, $tahun);
    ...
    public static function getRL51(int $tahun, int $bulan): array
    {
        ...
        foreach ($rows as $row) {
            $kode = $row->kd_penyakit;
            $kelUmur = SirsHelper::getAgeGroup($row->tgl_lahir, $row->tgl_registrasi);
            $jk = $row->jk;
    ...
    /** Helper: data kematian per kelompok ICD-10 (dipakai RL 4.2) */
    private static function getKematianByGroup(int $bulan, int $tahun): array
    {
        $rows = DB::connection(self::KONEKSI)->select("
