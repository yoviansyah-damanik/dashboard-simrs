...
class Rl53 extends Component
{
    ...
    {
        return view('pages.sirs.rl53', [
            'data' => SirsMorbidityRepository::getRL53($this->tahun, $this->bulan),
            'profil' => SirsHelper::getProfilRS(),
            'namaBulan' => SirsHelper::getMonthName($this->bulan),
        ])->title('RL 5.3 - 10 Besar Kunjungan Rawat Jalan');
    }
}
