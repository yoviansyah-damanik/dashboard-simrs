...
interface SirsClinicalInterface
{
    public static function getRL36(int $tahun, int $bulan): array;
    public static function getRL37(int $tahun, int $bulan): array;
    public static function getRL38(int $tahun, int $bulan): array;
    public static function getRL39(int $tahun, int $bulan): array;
    public static function getRL310(int $tahun, int $bulan): array;
    public static function getRL314(int $tahun, int $bulan): array;
}

class SirsClinicalRepository implements SirsClinicalInterface
{
    const KONEKSI = 'simrs';

    /** RL 3.6 - Pelayanan Kebidanan (persalinan) */
    public static function getRL36(int $tahun, int $bulan): array
    {
        ...
        $data = array_fill_keys(['normal', 'sectio', 'buatan', 'lainnya'], SirsHelper::emptyLPTotal());
    ...
    public static function getRL310(int $tahun, int $bulan): array
    {
        ...
        $masuk = DB::connection(self::KONEKSI)->select("
        ...
        $keluar = DB::connection(self::KONEKSI)->select("
    ...
    public static function getRL314(int $tahun, int $bulan): array
    {
        ...
        $hemodialisa = DB::connection(self::KONEKSI)->select("
        ...
        $operasi = DB::connection(self::KONEKSI)->select("
