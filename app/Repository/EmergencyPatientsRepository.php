...
interface EmergencyPatientsInterface
{
}

class EmergencyPatientsRepository implements EmergencyPatientsInterface
{
    ...
    public static function getAll(
        ...
        $result = $result
            ...
            ->where(RegisteredPatient::KODE_POLIKLINIK, RegisteredPatient::KODE_IGD)
