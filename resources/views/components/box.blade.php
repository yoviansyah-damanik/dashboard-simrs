<div
    ...
    <div @class([
        'absolute top-0 right-0 flex items-center justify-center bg-gradient-to-tr from-meta-3 to-primary text-whiten dark:bg-meta-4 transition-[width_height] duration-700',
