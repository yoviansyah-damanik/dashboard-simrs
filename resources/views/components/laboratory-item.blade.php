<div class="relative p-6 overflow-hidden bg-white border-l-4 lg:border-l-8 rounded-md drop-shadow-md
    ...
    <div class="xl:[column-count:4] sm:[column-count:3] [column-count:2] gap-x-3">
        ...
        <x-detail-item icon="i-ph-flask" label="Jenis Pemeriksaan"
            :value="$record['layanan']['jenis_pemeriksaan']" />
        <x-detail-item icon="i-ph-tag" label="Kategori" :value="$record['layanan']['kategori']" />
        ...
        <x-detail-item icon="i-ph-stethoscope" label="Dokter Perujuk"
            :value="$record['dokter']['nama_dokter']" />
