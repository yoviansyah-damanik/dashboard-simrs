...
use App\Repository\RegisteredPatientReportRepository;
...
class Report extends Component
{
    ...
    {
        return RegisteredPatientReportRepository::getSummary($this->startDate, $this->endDate);
    }

    public function render()
    {
        return view('pages.registered-patient.report');
    }
}
