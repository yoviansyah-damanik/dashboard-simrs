...
interface SirsOperativeInterface
{
    public static function getRL311(int $tahun): array;
    public static function getRL312(int $tahun, int $bulan): array;
    public static function getRL313(int $tahun): array;
    public static function getRL315(int $tahun): array;
    public static function getRL316(int $tahun): array;
}

class SirsOperativeRepository implements SirsOperativeInterface
{
    const KONEKSI = 'simrs';
