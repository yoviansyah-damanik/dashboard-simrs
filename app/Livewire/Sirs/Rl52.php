...
class Rl52 extends Component
{
    ...
    {
        return view('pages.sirs.rl52', [
            'data' => SirsMorbidityRepository::getRL52($this->tahun, $this->bulan),
            'profil' => SirsHelper::getProfilRS(),
            'namaBulan' => SirsHelper::getMonthName($this->bulan),
        ])->title('RL 5.2 - 10 Besar Kasus Baru Rawat Jalan');
    }
}
