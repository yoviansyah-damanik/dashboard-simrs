<x-content>
    <x-breadcrumb title="Farmasi" :items="[['title' => 'Layanan Penunjang Medis'], ['title' => 'Farmasi']]" />

    <div class="flex flex-col gap-3 lg:flex-row">
        <x-form.input type="search" block class="flex-1" wire:model.live.debounce.750ms="search"
            placeholder="Cari berdasarkan Nomor RM, Nama Pasien, No Rawat, atau No Resep" />
    ...
    <div class="grid grid-cols-2 gap-3 sm:grid-cols-4">
        ...
        <x-form.select label="Jenis Resep" block :items="$jenisResepList" wire:model.live='jenisResep' />
